...
public class VanillaDeathEvent extends CustomEvent implements DeathEvent {
    ...
    /**
     * What the killing blow was recorded as, falling back to {@code CUSTOM} when the entity kept no
     * last damage cause.
     */
    private final DamageCause cause;

    /**
     * What the killer was holding when it landed, or {@code null} when there was no killer, it held
     * nothing, or it was not the kind of entity that holds anything.
     */
     ...
     *
     * <p>Built from the item's effective name with its hover kept, so a renamed or enchanted weapon
     * reads in chat the way it reads in an inventory, and an unnamed one still reads as its item
     * type.</p>
     *
