...
public class UtilSearch {
    ...
    /**
     * Searches a collection for a matching element, sending any result or ambiguity messages
     * to the given {@link Audience} via {@link UtilMessage#message}.
     *
     * @param clazz             the element type's class
     * @param collection        the collection to search
     * @param typePredicate     predicate to pre-filter candidates, or {@code null} to skip
     ...
     * @param audience          the receiver to send result messages to
